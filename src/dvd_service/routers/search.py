...
async def _run_search(search: SearchService, req: SearchRequest, kind: str | None):
    try:
...
async def search_texts(
    ...
    """
    return await _run_search(search, req, "text")
...
async def search_tables(
    ...
    return await _run_search(search, req, "table")
...
async def search_all(
    ...
    return await _run_search(search, req, None)
...
async def search_user_index_texts(
    ...
    return await _run_search(search, _require_user_index_scope(req), "text")
...
async def search_user_index_tables(
    ...
    return await _run_search(search, _require_user_index_scope(req), "table")
...
async def search_user_index_all(
    ...
    return await _run_search(search, _require_user_index_scope(req), None)
